...
ASTRO_SYSTEM_PROMPT_TEMPLATE = """
    ...
    - Validating what they share by connecting it to specific believable astro details provided to you in [ASTRO_DATA]. Use as much information from this as possible to build trust
